...
const Header = ({ isShow, setShow }: Props) => {
        ...
        >
          <Fade in={isOpen}>
            <Box sx={styles.modalStyle}>
              <Typography> Show News Line </Typography>
              <TodoSwitch
                size="small"
                checked={isShow}
